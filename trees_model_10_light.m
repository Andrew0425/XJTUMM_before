...
center3 = [0, -d, -sqrt(2)*tan(deg2rad(10))*d/2];  % 将中心点在x轴上移动5个单位

% 树冠模型参数
a21 = 1.5; b21 = 1.5; c21 = 2; 
a22 = 1.5; b22 = 1.5; c22 = 1; 
center2 = [0, d, sqrt(2)*tan(deg2rad(10))*d/2];  % 将中心点在x轴上移动5个单位

% 树冠模型参数
a41 = 1.5; b41 = 1.5; c41 = 2; 
a42 = 1.5; b42 = 1.5; c42 = 1; 
center4 = [d, 0, sqrt(2)*tan(deg2rad(10))*d/2];  % 将中心点在x轴上移动5个单位

% 树冠模型参数
a51 = 1.5; b51 = 1.5; c51 = 2; 
a52 = 1.5; b52 = 1.5; c52 = 1; 
center5 = [-d, 0, -sqrt(2)*tan(deg2rad(10))*d/2];  % 将中心点在x轴上移动5个单位

% 树冠模型参数
a61 = 1.5; b61 = 1.5; c61 = 2; 
a62 = 1.5; b62 = 1.5; c62 = 1; 
center6 = [-d, -d, -sqrt(2)*tan(deg2rad(10))*d];  % 将中心点在x轴上移动5个单位
...
center8 = [-d, d, 0];  % 将中心点在x轴上移动5个单位

% 树冠模型参数
a91 = 1.5; b91 = 1.5; c91 = 2; 
a92 = 1.5; b92 = 1.5; c92 = 1; 
center9 = [d, d, sqrt(2)*tan(deg2rad(10))*d];  % 将中心点在x轴上移动5个单位
